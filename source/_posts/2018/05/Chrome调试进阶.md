...
![Preserve Log](https://ww1.sinaimg.cn/large/00749HCsly1frlvsaa7f5j30ns07sgm6.jpg)

## 代码断点与单步执行

![JavaScript代码调试_断点_说明](https://ww1.sinaimg.cn/large/00749HCsly1frjgwnaum2j31ft0hmjzr.jpg)
...
![按事件加断点](https://ww1.sinaimg.cn/large/00749HCsly1frjjtoxrttj30qo09575l.jpg)

同样, 如果某些库绑了太多无用代码, 你可以选择屏蔽这整个库. 比如, 把这个库加到 黑盒 里, 黑盒里 js 的执行过程不会被显示出来, 略有用

![屏蔽无用log](https://ww1.sinaimg.cn/large/00749HCsly1frjjxdjqrgj30ql0aw75k.jpg)
...
![保存为全局变量](https://ww1.sinaimg.cn/large/00749HCsly1frjhxwhwlcj30dl08pjrj.jpg)

## 调试 Immutable.js

虽然将变量保存了下来, 但如果调试的是 Immutable.js, 打印出来的 Immutable 对象其实会很难看.

![原始immutable对象打印效果](https://ww1.sinaimg.cn/large/00749HCsly1frji65o0ktj30iz06l0sz.jpg)

解决办法也简单, F12 打开开发者工具, 然后 F1 打开开发者工具的设置, 勾选`Preference->Console -> Enable Customer Formatters`

![开启Enable Customer Formatters](https://ww1.sinaimg.cn/large/00749HCsly1frji9k26gqj31hc0gpdhp.jpg)
...
![新immutable对象打印效果](https://ww1.sinaimg.cn/large/00749HCsly1frji9vkq22j30dt095gls.jpg)
...
![彩色log效果](https://ww1.sinaimg.cn/large/00749HCsly1frjy6sr74xj327y0yuwpb.jpg)
...
![RN日志](https://ww1.sinaimg.cn/large/00749HCsly1frjj3ya1hcj30sp0brn1p.jpg)

其实这个功能 Chrome 也可以做到, 还是 F1 打开开发者工具设置, 勾选`Preference->Console -> Show Timestamps`

![打开log时间戳](https://ww1.sinaimg.cn/large/00749HCsly1frjj8l0h9bj31h70g875y.jpg)

再看看日志, 是不是以后优化页面加载性能, 查看 js 执行瓶颈的时候就方便多了

![带时间戳的log](https://ww1.sinaimg.cn/large/00749HCsly1frjj9ci0r8j31hc0a4q4d.jpg)
...
![Console控制台说明](https://ww1.sinaimg.cn/large/00749HCsly1frjjr3k2nqj31hc0gmmyi.jpg)
...
![切换为移动端模式](https://ww1.sinaimg.cn/large/00749HCsly1frltmrdkcyj30pc0l3q7j.jpg)

如果想要模拟 App 操作的话, 只要选择 Edit, 添加上 App 的 UA 就可以了(具体值用 Charles 抓)

![更换UA_1](https://ww1.sinaimg.cn/large/00749HCsly1frmd6rnzvcj30mq0g4776.jpg)
![更换UA_2](https://ww1.sinaimg.cn/large/00749HCsly1frltst5my3j30ro0mst94.jpg)
...
![Chrome调试手机WebView](https://ww1.sinaimg.cn/large/00749HCsly1frlukz6y9rj31a20o1doa.jpg)
...
1.  微信内访问[https://debugx5.qq.com/](https://debugx5.qq.com/), 或者直接扫描二维码![二维码](https://ww1.sinaimg.cn/large/00749HCsly1frlv4pbutvj308c08ca9y.jpg)
2.  如果是首次使用需要先装线上 TBS 内核
    ![安装线上TBS内核](https://ww1.sinaimg.cn/large/00749HCsly1frlv77513rj30qo1hcju5.jpg)
...
4.  剩下的和 Chrome 远程调试一样, 折腾完打开[chrome://inspect/](chrome://inspect/), 完毕
    ![微信调试效果图](https://ww1.sinaimg.cn/large/00749HCsly1frlva13rsbj317y0m60xw.jpg)
...
![切换元素伪类状态](https://ww1.sinaimg.cn/large/00749HCsly1frlvkbaobej31hc0jejve.jpg)
...
![disable cache](https://ww1.sinaimg.cn/large/00749HCsly1frlvxom51bj30nl04cmxg.jpg)

## 模拟弱网条件 & 录制屏幕

Chrome 还允许模拟 2G/3G 等弱网环境, 而且为了方便调试, 还提供了录屏功能, 可以录制页面的整个加载过程, 方便检查分析

![录屏和模拟弱网](https://ww1.sinaimg.cn/large/00749HCsly1frlw4tbiq7j30nh0as0uv.jpg)

## 调试动画

和 Network 一样, 动画也提供了录屏, 模拟移动端 CPU 效果(主动降速), 分析动画成分功能

![Chrome动画调试指南_1](https://ww1.sinaimg.cn/large/00749HCsly1frlwgx6zy9j31hc0i3djp.jpg)
![Chrome动画调试指南_2](https://ww1.sinaimg.cn/large/00749HCsly1frlwh8gcjzj30o20ofdk0.jpg)
...
![密码找回](https://ww1.sinaimg.cn/large/00749HCsly1frlwm3r2gtj30le0feaf5.jpg)
...
![Chrome 查看源代码](https://ww1.sinaimg.cn/large/6671cfa8ly1frnq0euhx9j227y16ytrl.jpg)

![源码下载](https://ww1.sinaimg.cn/large/00749HCsly1frlwtp2tpkj30x70rc43d.jpg)

## Copy as Curl

如果要在命令行中模拟 Http 操作的话, 可以直接在 NetWork 面板中点右键, 这在手工抓接口数据的时候比较有用

![Copy as Curl](https://ww1.sinaimg.cn/large/00749HCsly1frlwxm1meoj30nz0bxac0.jpg)
