...
-  [vue中突破scoped限制, 覆盖子组件样式的方法](https://vue-loader.vuejs.org/zh/guide/scoped-css.html)
...
-  [为什么udp比tcp快, 但还是用tcp](https://www.zhihu.com/question/558479268/answer/3116626979)
...
- [如何画好架构图](https://mp.weixin.qq.com/s/T852Qww-RAERJDTQseCflw)
...
-   [nvm-国内镜像](https://gitee.com/RubyKids/nvm-cn)
    -   原理是利用gitee作为nvm-github的镜像, 进而保证国内的可用性
    -   太长不看 => `bash -c "$(curl -fsSL https://gitee.com/RubyKids/nvm-cn/raw/main/install.sh)"`
...
**user**: 还没写完哈, 请补充下你能做的操作和每个操作的含义吧
...
- [Chrome 插件](https://chrome.google.com/webstore/detail/save-all-resources/abpdnfjocnmdomablahdcfnoggeeiedb/related?hl=en-US)
  ...
  - ![使用示例](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1hc7l8lpwkhj321a10016x.jpg)
...
- [梅克尔树储备证明](https://mobile.twitter.com/BenWAGMI/status/1590213710332981248)
  ...
  - 通过加密数据结构证明交易所未挪用任何用户资金
    - ![梅克尔树-数据结构](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h80a55u6q9j31v117q16t.jpg)
    ...
    - ![验证方式](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h80aa3o8nvj31l417qn7t.jpg)
              ...
              - 注:
                - DEFLATE 是同时使用了 LZ77 算法与哈夫曼编码（Huffman Coding）的一个无损数据压缩算法, 被 RFC 1951 标准化
                  ...
                  - zip 算法
                    ...
                    - ![动态的Huffman编码流程](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h5ziq5tgznj30hj08kq4m.jpg)
...
- 前端代码体积的日常
  - `欢乐向`
  - ![前端代码体积的日常](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h52lykonxyj30eo0inwij.jpg)
- [前端工程师的深度或者核心竞争力体现在哪里？-欲三更的回答](https://www.zhihu.com/question/263926959/answer/275947141)
  ...
  - 示例 1: 流程图编辑器
    - ![流程图编辑器](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h534vxoqnvj30dw0dbac6.jpg)
    - > 基本共识:
  ...
  - 示例 2: 复杂框图加实时数据展示加鼠标操作，简称组态
    - ![组态](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h534yeqqywj30iw0an78o.jpg)
  - 示例 3 : 网页渲染 BIM
    - ![网页渲染CAD](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h534z7q4yvj30hs09dabw.jpg)
  - 示例 4: 复杂联动表单
    - ![复杂联动表单](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h534zunkqxj30dw09v758.jpg)
...
- [前端开发的难点到底在什么地方?-欲三更的回答](https://www.zhihu.com/question/275915023/answer/403127961)
  - `前端的难点`
  - ![监控器后台界面](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h5351grlx9j30u00hewog.jpg)
...
- [体验度量专题｜易用度在企业级中后台产品的探索和实践](https://zhuanlan.zhihu.com/p/266728471)
  ...
  - 易用度：使用**产品完成**工作的容易程度。
    - ![易用度量表](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h4nmgpuratj30u00kj45m.jpg)
  - 易用度-满意度-尖叫度-推荐度衡量维度对比
    - ![易用度-满意度-尖叫度-推荐度衡量维度对比](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h4nmi2ftnij30u00grgpc.jpg)
...
- 调度算法评价指标
  ...
  - ![调度算法评价指标](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h4msu45remj30z40og471.jpg)
...
- https://www.zhihu.com/question/61131777/answer/2545197189, 为什么在中国只有一个时区，但是却有很多的时区代码？
  ...
  - 在 java6 中, 对上海时区(Asia/Shanghai)而言, `1927-12-31 23:54:07` 和 `1927-12-31 23:54:08` 不是相差 1, 而是相差 353
    ...
    - js 中该值正常, 估计是时区数据库没有那么详细.
      ...
      ```
      - 原因在这里
        - ![中共中央办公厅、国务院办公厅关于在全国范围内实行夏时制的通知-中办发〔1986〕12号-1986年4月12日](https://mirror-4-web.bookflaneur.cn/https://tva1.sinaimg.cn/large/007Yq4pTly1h3ld7is0dlj30kk0zjtph.jpg)
